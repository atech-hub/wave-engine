...
pub fn print_help() {
    ...
    println!("    --layer-scale dyn   Per-layer residual scaling (model decides with spring)");
    println!("    --layer-scale V,V   Per-layer residual scaling (human prescribes, comma-separated)");
    println!("    --lr-scale dyn      Per-group LR scaling with hypergradient");
    println!("    --lr-scale V,V,V    Per-group LR scaling (human prescribes per layer + head)");
    ...
    println!("                        Phase coherence loss replaces cross-entropy through lm_head");
    println!("");
    println!("  Diagnostics:");
