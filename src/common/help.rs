...
pub fn print_help() {
    ...
    println!("    --phase-decode      Compare lm_head vs phase coherence decoding");
    println!();
    println!("PHASE ENCODE (encode directly into model phase angles):");
    println!("    --encode TEXT       Encode text through embedding table, observe ODE evolution");
    println!("    --encode-number N   Encode integer via multi-grid phases");
    println!("    --encode-catalog S  Encode catalog config: \"trine:35,63\", \"opposition:12,54\"");
    println!("                        Compound: \"trine:35,63+opposition:12,54\"");
    println!("                        Types: conjunction, opposition, trine, square, quintile,");
    println!("                        sextile, semi-square, semi-sextile, quincunx,");
    println!("                        sesquiquadrate, bi-quintile, quartet");
    println!("    --encode-phases S   Raw band:radian pairs: \"10:1.047,20:2.094\"");
    println!("    --inject-layer N    Inject at layer N input (default: 0 = full model)");
    println!("    --blank             Use untrained model (see what physics alone does)");
    ...
    println!("    --relate-catalog S      Add a catalog config to relate comparison");
    println!("    --relate-vocab          Full vocabulary pairwise relationship matrix");
    println!("    --output FILE           Output path for relate-vocab JSON");
    println!();
    println!("SCALING:");
    ...
    println!();
    println!("    # Encode a trine into a trained model");
    println!("    wave-engine --encode-catalog \"trine:35,63\" --resume checkpoint.bin");
    println!();
    println!("    # Compare what a blank vs trained model does to an opposition");
    println!("    wave-engine --encode-catalog \"opposition:20,60\" --blank --n-bands 84");
    println!("    wave-engine --encode-catalog \"opposition:20,60\" --resume checkpoint.bin");
    println!();
    println!("    # Relationship between tokens (with data file for vocab)");
    println!("    wave-engine --relate \"3\" --relate \"+\" --resume checkpoint.bin --data data/arithmetic.txt");
    println!();
    println!("    # Full vocabulary relationship map");
    println!("    wave-engine --relate-vocab --resume checkpoint.bin --data data/arithmetic.txt");
    println!();
