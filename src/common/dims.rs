...
impl Dims {
    ...
    pub fn with_ode_pathway(mut self, op: bool) -> Self {
        self.ode_pathway = op;
        self
    }
    pub fn with_attention_pathway(mut self, ap: bool) -> Self {
        self.attention_pathway = ap;
        self
    }
